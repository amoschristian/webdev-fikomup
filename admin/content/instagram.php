...
<table class="table table-striped">
    ...
    <tbody>
    <?php if($profile) : ?>
    <tr><td><b>Akun</b></td>	<td>: <?=  (isset($profile->username) ? $profile->username : "-") ?></td></tr>
    <tr><td><b>Tipe Akun</b></td>	<td>: <?=  (isset($profile->account_type) ? $profile->account_type : "-") ?></td></tr>
    <tr><td><b>Jumlah Gambar</b></td>	<td>: <?=  (isset($profile->media_count) ? $profile->media_count : "-") ?></td></tr>
    <?php endif; ?>
